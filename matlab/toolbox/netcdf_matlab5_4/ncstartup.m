...
toolbox_area = 'toolbox/local';

path(path, fullfile(matlabroot, toolbox_area, 'netcdf_matlab5', ''))
path(path, fullfile(matlabroot, toolbox_area, 'netcdf_matlab5', 'nctype', ''))
path(path, fullfile(matlabroot, toolbox_area, 'netcdf_matlab5', 'ncutility', ''))
