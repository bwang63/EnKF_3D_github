function theResult = surf(varargin)

% ncvar/surf -- Surface-plot of a NetCDF variable.
%  surf(z, 'thePen') surfs NetCDF variable z, an
%   "ncvar" object, using 'thePen'.  The x, y, and
%   z axes are labeled with the names and units of
%   the corresponding coordinate variables.  The
%   title is set to the name of the z variable.
