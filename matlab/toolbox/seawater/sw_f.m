...
%  beta is the variation of f with latitude [m-1 s-1] 
%
% AUTHOR:  Phil Morgan 93-04-20  (morgan@ml.csiro.au)
%          Modified by John Wilkin to add beta output
%
% DISCLAIMER:
...
if nargout == 2
  radiusofearth = 6370800; % metres
  beta = 2*OMEGA*cos(lat*DEG2RAD)/radiusofearth;
end
