...
% Version of 19-Sep-1997 10:11:59.
...
theLayout = [ 99  99  99  99  99  99  99  99  99   % Title.
               ...
               8   8   8   9   9 inf inf inf inf;
              10  10 Inf inf inf  11  11  12  12]; % Catalog, info, listing.
...
theSize = size(super(result));
set(theControls(7), 'String', mat2str(theSize(1:3)))
set(theControls(13), 'String', theNetCDFFile);
...
set(theControls(10:12), 'BackgroundColor', yellowish);
