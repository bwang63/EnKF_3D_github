function t = equidist_spline2 ( x, y, old_t, new_t_length )
% EQUIDIST_SPLINE2:  Computes equi-distant spacing along a 2D spline.
%
% USAGE:  t = equidist_spline2 ( x, y, old_t, new_t_length );
%
% PARAMETERS:
%   x, y:  Points of spline curve in x and y directions.
...
%ppx = csape ( old_t, x, 'variational' );
%ppy = csape ( old_t, y, 'variational' );
ppx = spline ( old_t, x );
ppy = spline ( old_t, y );
...
equidist = tot_dist(n) * linspace ( 0, 1.0, new_t_length );
