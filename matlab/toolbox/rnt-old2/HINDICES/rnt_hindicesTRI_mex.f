...
C      integer*8 Xpos,Ypos,Xgrd,Ygrd,Ipos,Jpos,triX,triY,Ival,Jval
C      integer*8 mxGetPr, mxCreateFull

      integer plhs(*), prhs(*)
      integer Xpos,Ypos,Xgrd,Ygrd,Ipos,Jpos,triX,triY,Ival,Jval
