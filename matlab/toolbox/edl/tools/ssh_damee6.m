...
outname='damee6_Lclm_b.nc';

%  Set Input NetCDF files.

grdname='damee6_grid_b.nc';

jan='/e0/arango/Damee/grid6/OA/oa6_ssh_jan.nc';
feb='/e0/arango/Damee/grid6/OA/oa6_ssh_feb.nc';
mar='/e0/arango/Damee/grid6/OA/oa6_ssh_mar.nc';
apr='/e0/arango/Damee/grid6/OA/oa6_ssh_apr.nc';
may='/e0/arango/Damee/grid6/OA/oa6_ssh_may.nc';
jun='/e0/arango/Damee/grid6/OA/oa6_ssh_jun.nc';
jul='/e0/arango/Damee/grid6/OA/oa6_ssh_jul.nc';
aug='/e0/arango/Damee/grid6/OA/oa6_ssh_aug.nc';
sep='/e0/arango/Damee/grid6/OA/oa6_ssh_sep.nc';
oct='/e0/arango/Damee/grid6/OA/oa6_ssh_oct.nc';
nov='/e0/arango/Damee/grid6/OA/oa6_ssh_nov.nc';
dec='/e0/arango/Damee/grid6/OA/oa6_ssh_dec.nc';
