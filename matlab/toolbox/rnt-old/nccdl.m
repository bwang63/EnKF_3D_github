function nccdl(file1,file2,doeval)
%function nccdl(file1,file2)
% Create a cdl file and nc files replica if wanted
% file1 is orgin , file2 is destination
%
% if doeval == 1  Create also NC file
% if doeval ~= 1  Create CDL.m file only
% Manu - edl@ucsd.edu

%file1='init-levitus.nc'
%file2='init-manu.nc'
...
%	duplicate file
%==========================================================
ncduplicate(file1,'tmp_duplicate.m',file2);
[s,w]=unix(['echo  `echo ',file2,'  |cut -f1 -d"."`_cdl.m ']);
unix(['mv tmp_duplicate.m ',w]);
disp(['Created  ',w]);
...
%	NCDUPLICATE
%==========================================================
function ncduplicate(theNetCDFFile, theOutputFile,ncOutfile)
