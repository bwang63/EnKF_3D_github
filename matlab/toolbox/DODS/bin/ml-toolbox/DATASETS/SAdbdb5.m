%
%  Digital Bathymetric Data Base - 5 minute Resolution (DBDB5) for the Sount Atlantic
...
Cat_m_File = 'dummy';
CatalogServer = 'http://pdas.navo.navy.mil/cgi-bin/nph-nc/data/DBDBV/DBDB5-south_atlantic.nc';

LonRange = [290-0.0833333/1.98 390+0.0833333/1.98];
LatRange =  [-80-0.0833333/1.98 0+0.0833333/1.98];
...
DataName = 'Bathymetry - DBDB5 South Atlantic - NAVOCEANO';
...
Comments2 = sprintf('%s\n', ...
'      South Atlantic Coverage of the Digital Bathymetry Data Base 5 Min Resolution',...
'     ',...
