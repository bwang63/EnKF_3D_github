%
%    FILE DESCRIBING FSU Monthly Averaged Wind Stresses (Unsmoothed) DATASET
...
% VARIABLES -- OPTIONAL
CatalogServer = 'http://dods.gso.uri.edu/cgi-bin/nph-dods/catalog/fsu_nscat7fs.dat';
...
DataName = 'Wind - Gridded, Smoothed NSCAT Monthly Wind Stress - COAPS(FSU)';
...
%COMMENTS
Comments1 = sprintf('%s\n', ...
'       COAPS NSCAT (Smoothed) Gridded Monthly Surface Wind Stresses', ...
' ', ...
...
% $Id: fsun7.m,v 1.6 2002/08/15 03:57:46 dan Exp $
%
...
%
% Revision 1.6  2000/03/17 16:57:30  dbyrne
%
%
...
% -- dbyrne 00/03/17
%
% Revision 1.5  1999/10/27 22:18:21  dbyrne
% *** empty log message ***
%
...
%
% Revision 1.1  1999/05/21 16:55:51  paul
