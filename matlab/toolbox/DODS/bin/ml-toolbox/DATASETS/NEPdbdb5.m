%
%  Digital Bathymetric Data Base -  5 minute Resolution (DBDB5) for the Northeast Pacific
...
Cat_m_File = 'dummy';
CatalogServer = 'http://pdas.navo.navy.mil/cgi-bin/nph-nc/data/DBDBV/DBDBV_ne_pacific.nc';

  
LonRange = [179.9581  288.0419];
LatRange =  [-0.0419   70.0419];
...
DataName = 'Bathymetry - DBDB5 Northeast Pacific - NAVOCEANO';
...
Comments2 = sprintf('%s\n', ...
'      Northeast Pacific Coverage of the Digital Bathymetry Data Base 5 Min Resolution',...
'     ',...
