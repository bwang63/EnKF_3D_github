%
%  Digital Bathymetric Data Base -  5 minute Resolution (DBDB5) for the Southeast Pacific
...
Cat_m_File = 'dummy';
CatalogServer = 'http://pdas.navo.navy.mil/cgi-bin/nph-nc/data/DBDBV/DBDBV_se_pacific.nc';

  
LonRange = [179.9581  292.0419];
...
DataName = 'Bathymetry - DBDB5 Southeast Pacific - NAVOCEANO';
...
Comments2 = sprintf('%s\n', ...
'      Southeast Pacific Coverage of the Digital Bathymetry Data Base 5 Min Resolution',...
'     ',...
