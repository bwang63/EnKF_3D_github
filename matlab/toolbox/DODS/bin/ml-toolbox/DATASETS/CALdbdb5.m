%
%  Digital Bathymetric Data Base - 1 minute Resolution (DBDB5) for waters off California
...
Cat_m_File = 'dummy';
CatalogServer = 'http://pdas.navo.navy.mil/cgi-bin/nph-nc/data/DBDBV/DBDBV_California_1Minute.nc';

LonRange = [-140.0084 -111.9916];
LatRange =  [28.9916   45.0084];
...
DataName = 'Bathymetry - DBDB5 California Coastal Region - NAVOCEANO';
...
Comments2 = sprintf('%s\n', ...
'      Calfornia Coastal Coverage of the Digital Bathymetry Data Base 1 Min Resolution',...
'     ',...
'     This subset of the DBDB-V database provides ocean depths at every oceanic geographic',...
'     position evenly divisible by 1 minutes of latitude and longitude. ',...
'     ',...
