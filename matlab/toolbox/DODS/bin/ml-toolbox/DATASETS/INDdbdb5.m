%
%  Digital Bathymetric Data Base - 1 minute Resolution (DBDB5) for the Indian Ocean
...
Cat_m_File = 'dummy';
CatalogServer = 'http://pdas.navo.navy.mil/cgi-bin/nph-nc/data/DBDBV/DBDBV_indian_5minute.nc';

  
LonRange = [14.9581  120.0419];
LatRange =  [-72.0419  38.0419];
...
DataName = 'Bathymetry - DBDB5 Indian Ocean - NAVOCEANO';
...
Comments2 = sprintf('%s\n', ...
'      Indian Ocean Coverage of the Digital Bathymetry Data Base 5 Min Resolution',...
'     ',...
