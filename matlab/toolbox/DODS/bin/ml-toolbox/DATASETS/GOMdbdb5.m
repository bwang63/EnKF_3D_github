%
%  Digital Bathymetric Data Base - 5 minute Resolution (DBDB5) for the Gulf of Mexico
...
Cat_m_File = 'dummy';
CatalogServer = 'http://pdas.navo.navy.mil/cgi-bin/nph-nc/data/DBDBV/DBDBV_gulf_of_mexico.nc';

LonRange = [259.9581  281.0419];
LatRange =  [16.9581   32.0419];
...
DataName = 'Bathymetry - DBDB5 Gulf of Mexico - NAVOCEANO';
...
Comments2 = sprintf('%s\n', ...
'      Gulf of Mexico Coverage of the Digital Bathymetry Data Base 5 Min Resolution',...
'     ',...
