%
%  Digital Bathymetric Data Base - 5 minute Resolution (DBDB5) for the North Atlantic
...
Cat_m_File = 'dummy';
CatalogServer = 'http://pdas.navo.navy.mil/cgi-bin/nph-nc/data/DBDBV/DBDBV_north_atlantic.nc';

LonRange = [277.9581  372.0419];
LatRange =  [-0.0419   65.0419];
...
DataName = 'Bathymetry - DBDB5 North Atlantic - NAVOCEANO';
...
Comments2 = sprintf('%s\n', ...
'      North Atlantic Coverage of the Digital Bathymetry Data Base 5 Min Resolution',...
'     ',...
