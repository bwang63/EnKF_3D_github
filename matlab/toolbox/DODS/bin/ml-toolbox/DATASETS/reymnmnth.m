...
% VARIABLES -- OPTIONAL
Server = 'http://www.cdc.noaa.gov/cgi-bin/nph-nc/Datasets/reynolds_sst/sst.mnmean.nc';

% VARIABLES -- REQUIRED
LonRange = [0.0 360.0];
LatRange = [90.0 -90.0];
TimeRange = [1981.824657534247 str2num(datestr(date,10))+2];
DepthRange = [0 0];
DepthUnits = '';
Resolution = 111.0;
...
DataName = 'Reynolds Blended SST Monthly means - NCEP';   
