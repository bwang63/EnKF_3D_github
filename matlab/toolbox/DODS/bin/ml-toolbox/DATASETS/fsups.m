...
Server = 'http://www.coaps.fsu.edu/cgi-bin/nph-nc/WOCE/SAC/fsuwinds/pacftp/pac_pstress.61-97.nc';
Ntime = 444;

LonRange = [123 291];
LatRange = [-30 30];
TimeRange = [1961.0 1998.0];
DepthRange = [0.0 0.0];
Resolution = 222;
...
DataName = 'Wind - Pacific Monthly Pseudostress Averages - FSU';
...
'    time period 1961-1998 for that month binned on a global 2x2 degree grid.',...
'    ', ...
