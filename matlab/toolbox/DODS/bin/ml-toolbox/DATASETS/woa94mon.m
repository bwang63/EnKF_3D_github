...
% VARIABLES -- OPTIONAL
Server = 'http://ferret.wrc.noaa.gov/cgi-bin/nph-nc/data/Ocean_atlas_monthly.nc';
...
Comments1 = sprintf('%s\n', ...
    ...
    '    the results were median filtered to yield monthly climatologies resolved at ',...
    '    one degree in latitude and longitude. The WOA94 procedures were developed ',...
    '    and applied to not only create surface climatologies but those at standard ',...
    '    depth levels to 1000m as well. ', ...
    '     ', ...
    '    The dataset consists of temperature and salinity in the',...
