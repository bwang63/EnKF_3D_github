%
% FSU Pacific Climatological Monthly Pseudostress Averages 1961-1992

GetFunctionName = 'getrectg';
Server = 'http://www.coaps.fsu.edu/cgi-bin/nph-nc/WOCE/SAC/fsuwinds/pacftp/pac_pstress.clim.61-92.nc';
...
DataName = 'Wind - Pacific Monthly Climatology Pseudostress (1961-1992) - FSU';
...
'    time period 1961-1992 for that month binned on a global 2x2 degree grid (i.e., the ',...
...
'         Beginning_Date: Jan. 1, 1961 ', ...
'         Ending_Date: Dec. 31, 1992 ', ...
'    Spatial_Domain = ', ...
