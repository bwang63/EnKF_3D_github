...
% VARIABLES -- OPTIONAL
CatalogServer = ...
    'http://dods.gso.uri.edu/cgi-bin/nph-dods/catalog/fsu_nscat1fs.dat';
...
DataName = 'Wind - Level 3 NSCAT 1/2-Deg. Averaged - COAPS(FSU)';
%LongitudeName = 'lon';
%LatitudeName = 'lat';
%TimeName = '';
%DepthName = '';
...
' These products are on a half degree grid, for each day scatterometer', ...
...
' This approach bins the satellite swath observations (in 0.5 degree bins)', ...
...
Data_Use_Policy='';
% $Id: fsun1.m,v 1.6 2002/08/15 03:57:46 dan Exp $
%
...
%
% Revision 1.5  2002/04/15 19:55:12  dan
% Changed name of selectable variable.
%
% Revision 1.4  2002/01/22 21:23:38  dan
...
% -- dbyrne 00/03/17
%
% Revision 1.4  1999/09/21 13:49:14  paul
