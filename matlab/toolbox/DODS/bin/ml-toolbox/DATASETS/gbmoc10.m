%
%  GLOBEC MOCNESS 10 m^2 CTD Data
...
% $Id: gbmoc10.m,v 1.1 2000/09/19 20:50:41 kwoklin Exp $
% klee 09/2000
% klee 04/1999

GetFunctionName = 'getjgsta';
Server = 'http://dods.gso.uri.edu/cgi-bin/nph-jg/mocctd?&datatype=MOCNESS_10'; 
Cat_m_File = 'gbcat';
URL_m_File = 'gburl';
...
DataName = 'Water Column - CTD collected from MOCNESS_10 hauls - WHOI/GLOBEC ';
%%LongitudeName = 'lon';
%%LatitudeName = 'lat';
...
'         Beginning_Date: Feb. 11, 1995 (1995.11410270) ', ...
'         Ending_Date:    Feb. 18, 1999 (1999.13225805)', ...
'    Spatial_Domain = ', ...
'         Bounding Coordinates: ', ...
'              West Bounding Coordinate: 69.0041 W ', ...
'              East Bounding Coordinate: 65.8476 W ', ...
'              South Bounding Coordinate: 40.4024 N ', ...
'              North Bounding Coordinate: 42.3500 N ', ...
'   ', ...
'    Point_of_Contact = ', ...
'         Address - si: ', ...
'               Erich Horgan',...
