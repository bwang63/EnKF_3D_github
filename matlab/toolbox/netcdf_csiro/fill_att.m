...
%  FILL_ATT fills a row of an array with an attribute of a variable
%--------------------------------------------------------------------
...
%     RCSfile  $RCSfile: fill_att.m,v $
% @(#)fill_att.m   1.2   92/03/10
% 
%--------------------------------------------------------------------
...
new_max = 25;
for i = 0:nvatts-1
   [attnam, rcode] = ncmex('ncattname', cdfid, varid, i);
   if rcode == -1
