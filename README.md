...
- Search for '(edit)' to find settings that need changes to run this application. Note that only the paths of the varinfo file and the grid file have to be specified. The path to other input and output files will be generated by the MATLAB script. 
