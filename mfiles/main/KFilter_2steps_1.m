...
assim_opt.temp = 1;                                % temperature
assim_opt.salt = 0;                                  % salinity
assim_opt.NO3 = 1;                                % NO3
assim_opt.NH4 = 0;                                 % NH4
assim_opt.chlorophyll = 0;                       % chlorophyll
assim_opt.phytoplankton = 0;                   % phytoplankton
...
provenance_opt.SSH = 1; % to assimilate SSH data                           
provenance_opt.SST = 1;  % to assimilate SST data                           
provenance_opt.Tprof = 1;                            
provenance_opt.SChl = 0;                              
provenance_opt.Nprof = 0;                              
...
% only biological variables are log-transformed or other-transformed 
...
%
kfparams.runcase = 'EnKF_2steps_1';  % edit
